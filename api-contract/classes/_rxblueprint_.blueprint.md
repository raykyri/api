...
*Defined in [RxBlueprint.ts:37](https://github.com/polkadot-js/api/blob/28cf21d/packages/api-contract/src/RxBlueprint.ts#L37)*
...
*Defined in [RxBlueprint.ts:45](https://github.com/polkadot-js/api/blob/28cf21d/packages/api-contract/src/RxBlueprint.ts#L45)*
