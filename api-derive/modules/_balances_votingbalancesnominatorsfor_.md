...
*Defined in [balances/votingBalancesNominatorsFor.ts:15](https://github.com/polkadot-js/api/blob/0196829/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L15)*
