...
*Defined in [balances/votingBalancesNominatorsFor.ts:15](https://github.com/polkadot-js/api/blob/3827353/packages/api-derive/src/balances/votingBalancesNominatorsFor.ts#L15)*
