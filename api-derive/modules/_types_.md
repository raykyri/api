...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/3d7a460/packages/api-derive/src/types.ts#L19)*
...
*Defined in [types.ts:85](https://github.com/polkadot-js/api/blob/3d7a460/packages/api-derive/src/types.ts#L85)*