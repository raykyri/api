...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/5e0f62c/packages/api-derive/src/types.ts#L19)*
...
*Defined in [types.ts:85](https://github.com/polkadot-js/api/blob/5e0f62c/packages/api-derive/src/types.ts#L85)*