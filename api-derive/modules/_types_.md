...
*Defined in [types.ts:21](https://github.com/polkadot-js/api/blob/72af35d/packages/api-derive/src/types.ts#L21)*
...
*Defined in [types.ts:87](https://github.com/polkadot-js/api/blob/72af35d/packages/api-derive/src/types.ts#L87)*