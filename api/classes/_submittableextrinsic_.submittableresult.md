...
*Defined in [SubmittableExtrinsic.ts:65](https://github.com/polkadot-js/api/blob/66ab3ac/packages/api/src/SubmittableExtrinsic.ts#L65)*
...
*Defined in [SubmittableExtrinsic.ts:63](https://github.com/polkadot-js/api/blob/66ab3ac/packages/api/src/SubmittableExtrinsic.ts#L63)*
...
*Defined in [SubmittableExtrinsic.ts:72](https://github.com/polkadot-js/api/blob/66ab3ac/packages/api/src/SubmittableExtrinsic.ts#L72)*
...
*Defined in [SubmittableExtrinsic.ts:76](https://github.com/polkadot-js/api/blob/66ab3ac/packages/api/src/SubmittableExtrinsic.ts#L76)*
...
*Defined in [SubmittableExtrinsic.ts:80](https://github.com/polkadot-js/api/blob/66ab3ac/packages/api/src/SubmittableExtrinsic.ts#L80)*
...
*Defined in [SubmittableExtrinsic.ts:87](https://github.com/polkadot-js/api/blob/66ab3ac/packages/api/src/SubmittableExtrinsic.ts#L87)*
