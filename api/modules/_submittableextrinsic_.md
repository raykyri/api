...
*Defined in [SubmittableExtrinsic.ts:29](https://github.com/polkadot-js/api/blob/43ca02b/packages/api/src/SubmittableExtrinsic.ts#L29)*
...
*Defined in [SubmittableExtrinsic.ts:34](https://github.com/polkadot-js/api/blob/43ca02b/packages/api/src/SubmittableExtrinsic.ts#L34)*
...
*Defined in [SubmittableExtrinsic.ts:108](https://github.com/polkadot-js/api/blob/43ca02b/packages/api/src/SubmittableExtrinsic.ts#L108)*
