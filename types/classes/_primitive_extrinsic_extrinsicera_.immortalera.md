...
*Defined in [primitive/Extrinsic/ExtrinsicEra.ts:36](https://github.com/polkadot-js/api/blob/3827353/packages/types/src/primitive/Extrinsic/ExtrinsicEra.ts#L36)*
