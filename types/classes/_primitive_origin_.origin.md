...
*Defined in [primitive/Origin.ts:13](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/primitive/Origin.ts#L13)*
...
*Defined in [primitive/Origin.ts:23](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/primitive/Origin.ts#L23)*
