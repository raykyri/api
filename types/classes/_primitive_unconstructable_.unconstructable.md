...
*Defined in [primitive/Unconstructable.ts:14](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/primitive/Unconstructable.ts#L14)*
...
*Defined in [primitive/Unconstructable.ts:21](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/primitive/Unconstructable.ts#L21)*
