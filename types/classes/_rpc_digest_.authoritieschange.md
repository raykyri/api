...
\+ **new AuthoritiesChange**(`Type`: [Constructor](../interfaces/_types_.constructor.md)‹*`T`*›, `value`: [Vector](_codec_vector_.vector.md)‹*any*› | `Uint8Array` | string | any[]): *[AuthoritiesChange](_rpc_digest_.authoritieschange.md)*
