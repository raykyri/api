...
\+ **new PendingPause**(`Types`: `S`, `value`: `V` | `Map<any, any>` | any[], `jsonMap`: `Map<keyof S, string>`): *[PendingPause](_srml_grandpa_types_.pendingpause.md)*
...
*Defined in [srml/grandpa/types.ts:16](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/srml/grandpa/types.ts#L16)*
...
*Defined in [srml/grandpa/types.ts:15](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/srml/grandpa/types.ts#L15)*
