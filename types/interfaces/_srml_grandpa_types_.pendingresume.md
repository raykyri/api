...
\+ **new PendingResume**(`Types`: `S`, `value`: `V` | `Map<any, any>` | any[], `jsonMap`: `Map<keyof S, string>`): *[PendingResume](_srml_grandpa_types_.pendingresume.md)*
...
*Defined in [srml/grandpa/types.ts:21](https://github.com/polkadot-js/api/blob/dd7b138/packages/types/src/srml/grandpa/types.ts#L21)*
...
*Defined in [srml/grandpa/types.ts:20](https://github.com/polkadot-js/api/blob/dd7b138/packages/types/src/srml/grandpa/types.ts#L20)*
