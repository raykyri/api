...
\+ **new StoredPendingChange**(`Types`: `S`, `value`: `V` | `Map<any, any>` | any[], `jsonMap`: `Map<keyof S, string>`): *[StoredPendingChange](_srml_grandpa_types_.storedpendingchange.md)*
...
*Defined in [srml/grandpa/types.ts:26](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/srml/grandpa/types.ts#L26)*
...
*Defined in [srml/grandpa/types.ts:27](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/srml/grandpa/types.ts#L27)*
...
*Defined in [srml/grandpa/types.ts:25](https://github.com/polkadot-js/api/blob/3d7a460/packages/types/src/srml/grandpa/types.ts#L25)*
