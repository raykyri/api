...
\+ **new OpaqueNetworkState**(`Types`: `S`, `value`: `V` | `Map<any, any>` | any[], `jsonMap`: `Map<keyof S, string>`): *[OpaqueNetworkState](_srml_imonline_types_.opaquenetworkstate.md)*
...
*Defined in [srml/imOnline/types.ts:19](https://github.com/polkadot-js/api/blob/dd7b138/packages/types/src/srml/imOnline/types.ts#L19)*
...
*Defined in [srml/imOnline/types.ts:18](https://github.com/polkadot-js/api/blob/dd7b138/packages/types/src/srml/imOnline/types.ts#L18)*
