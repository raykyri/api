...
\+ **new IncomingParachainFixed**(`Types`: `S`, `value`: `V` | `Map<any, any>` | any[], `jsonMap`: `Map<keyof S, string>`): *[IncomingParachainFixed](_srml_parachains_types_.incomingparachainfixed.md)*
...
*Defined in [srml/parachains/types.ts:77](https://github.com/polkadot-js/api/blob/61065a2/packages/types/src/srml/parachains/types.ts#L77)*
...
*Defined in [srml/parachains/types.ts:78](https://github.com/polkadot-js/api/blob/61065a2/packages/types/src/srml/parachains/types.ts#L78)*
