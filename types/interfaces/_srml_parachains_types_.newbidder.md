...
\+ **new NewBidder**(`Types`: `S`, `value`: `V` | `Map<any, any>` | any[], `jsonMap`: `Map<keyof S, string>`): *[NewBidder](_srml_parachains_types_.newbidder.md)*
...
*Defined in [srml/parachains/types.ts:83](https://github.com/polkadot-js/api/blob/61065a2/packages/types/src/srml/parachains/types.ts#L83)*
...
*Defined in [srml/parachains/types.ts:82](https://github.com/polkadot-js/api/blob/61065a2/packages/types/src/srml/parachains/types.ts#L82)*
