...
* [constructor](_srml_session_types_.erarewards.md#constructor)

### Properties

* [rewards](_srml_session_types_.erarewards.md#rewards)
* [total](_srml_session_types_.erarewards.md#total)

### Accessors

* [Type](_srml_session_types_.erarewards.md#type)
* [encodedLength](_srml_session_types_.erarewards.md#encodedlength)
* [isEmpty](_srml_session_types_.erarewards.md#isempty)

### Methods

* [eq](_srml_session_types_.erarewards.md#eq)
* [get](_srml_session_types_.erarewards.md#get)
* [getAtIndex](_srml_session_types_.erarewards.md#getatindex)
* [toArray](_srml_session_types_.erarewards.md#toarray)
* [toHex](_srml_session_types_.erarewards.md#tohex)
* [toJSON](_srml_session_types_.erarewards.md#tojson)
* [toRawType](_srml_session_types_.erarewards.md#torawtype)
* [toString](_srml_session_types_.erarewards.md#tostring)
* [toU8a](_srml_session_types_.erarewards.md#tou8a)
* [with](_srml_session_types_.erarewards.md#static-with)

## Constructors

###  constructor

\+ **new EraRewards**(`Types`: `S`, `value`: `V` | `Map<any, any>` | any[] | string, `jsonMap`: `Map<keyof S, string>`): *[EraRewards](_srml_session_types_.erarewards.md)*
...
**Returns:** *[EraRewards](_srml_session_types_.erarewards.md)*

## Properties

###  rewards

• **rewards**: *[Vector](../classes/_codec_vector_.vector.md)‹*`u32`*›*

*Defined in [srml/session/types.ts:10](https://github.com/polkadot-js/api/blob/1525d64/packages/types/src/srml/session/types.ts#L10)*
...
*Defined in [srml/session/types.ts:9](https://github.com/polkadot-js/api/blob/1525d64/packages/types/src/srml/session/types.ts#L9)*
