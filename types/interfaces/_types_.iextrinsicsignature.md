...
*Defined in [types.ts:164](https://github.com/polkadot-js/api/blob/ebc2fbe/packages/types/src/types.ts#L164)*
...
*Defined in [types.ts:165](https://github.com/polkadot-js/api/blob/ebc2fbe/packages/types/src/types.ts#L165)*
